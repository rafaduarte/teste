                             ...
                             <input style="width: 100%; border-style: outset" type="text" class="money" value="{{ request('icms_total_pago_junho') }}" name="icms_total_pago_junho" class="form-control">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">                                                                                                   
                                     ...
                                     <input style="width: 100%; border-style: outset" type="text" class="money" value="{{ request('investimento_realizado_abril') }}" name="investimento_realizado_abri" class="form-control">                                    
