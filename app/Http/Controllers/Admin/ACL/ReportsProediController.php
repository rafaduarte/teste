...
{   
    ...
    public function trimestre(Request $request){
       ...
       // $data = $request->all();
        ...
        $faturamentoJaneiro = $request->get('faturamento_janeiro');
        $faturamentoFevereiro = $request->get('faturamento_fevereiro');
        $faturamentoMarco = $request->get('faturamento_marco'); 
        ...
        $icmsDevidoJaneiro = $request->get('icms_total_devido_janeiro');
        $icmsDevidoFeveiro = $request->get('icms_total_devido_fevereiro');
        $icmsDevidoMarco = $request->get('icms_total_devido_marco');
        $icmsPagoJaneiro = $request->get('icms_total_pago_janeiro');
        $icmsPagoFevereiro = $request->get('icms_total_pago_fevereiro');
        $icmsPagoMarco = $request->get('icms_total_pago_marco');
        $investimentoProjetado = $request->get('investimento_projetado');
        $investimentoRealizadoJaneiro = $request->get('investimento_realizado_janeiro');
        $investimentoRealizadoFevereiro = $request->get('investimento_realizado_fevereiro');
        $investimentoRealizadoMarco = $request->get('investimento_realizado_marco');
        $investimentoRealizadoProedi = $request->get('investimento_total_realizado');
